...
When the bot returns a valid target post/comment you can be notified via an email, posting to a slack channel, or saving the link in a text document.

Icebox:
    - Segnment user watchlist by competitors
    - Automatically add users to competitor list based on post/comment
